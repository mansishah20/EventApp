...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  @if(session()->has('name'))
      <li class="nav-item @@blog">
	      <a class="navbar-brand" href="/admin/logout"><span class="glyphicon glyphicon-log-in"></span><b> Logout</b></a>
      </li>
	  @else 
      <li class="nav-item @@blog" >
       <a class="navbar-brand" href="/admin/login"><span class="glyphicon glyphicon-log-in"></span> <b>Login</b></a>
      </li>
	  @endif  
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href='/admin/signup'>Registration</a>
      </li>
      <li class="nav-item">
